...
const Header = ({openNav}:Props) => {
  ...
  return (
    <div className={`transition-all ${navBg? 'bg-white shadow-md' : 'fixed'} duration-200 z-[100] fixed w-full bg-white`}>
      <div className="container-fluid flex items-center h-full justify-between w-[90%] mx-auto py-6">
